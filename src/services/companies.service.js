...
async function create(body) {
    const { name, code, gstNo, contactEmail, contactName, contactMobile, validFrom, expireAt, maxUsers } = await body
    const data = await prisma.company.create({
        data: {
            name, code, gstNo, contactEmail, contactName, contactMobile: parseInt(contactMobile),
            branch: {
                create: {
                    branchName: name,
                    branchCode: code,
...
async function update(id, body) {
    const { name, code, gstNo, contactEmail, contactName, contactMobile } = await body
