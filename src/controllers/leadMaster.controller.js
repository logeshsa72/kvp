...
import { get as _get, getOne as _getOne, getSearch as _getSearch, create as _create, update as _update, remove as _remove, importLead as _importLead } from '../services/leadMaster.service.js';
...
export async function importLead(req, res, next) {
    try {
        res.json(await _importLead(req.body));
        console.log(res.statusCode);
    } catch (error) {
        console.error(`Error`, error.message);
        if (error instanceof Prisma.PrismaClientKnownRequestError) {
