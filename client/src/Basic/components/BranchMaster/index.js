...
import { TextInput, CheckBox, DisabledInput } from "../../../Inputs"
...
export default function BranchMaster({ companyCode, setBranchForm}) {
    ...
    const data = {
        ...
        contactMobile: contactMobileBranch, contactName: contactNameBranch, companyId, id
    }
    ...
    return (
        <div onKeyDown={handleKeyDown} className='md:items-start md:justify-items-center grid h-full bg-theme'>
            <div className='flex flex-col frame w-full h-full'>
                <FormHeader onNew={onNew} onClose={() => { setSearchValue(""); setBranchForm(false); }} model={MODEL} saveData={saveData} setReadOnly={setReadOnly} deleteData={deleteData} childRecord={childRecord.current} />
                        ...
                        <div className='mr-1 md:ml-2'>
                            <fieldset className='my-1 row-span-2 overflow-auto'>
                                ...
                                <div className='grid grid-cols-1 my-2'>
                                    <DisabledInput name="Company Code" type="text" value={companyCode} />
                                    <TextInput name="Branch Name" type="text" value={nameBranch} setValue={setNameBranch} required={true} readOnly={readOnly}/>
                                    <TextInput name="Branch Code" type="text" value={codeBranch} setValue={setCodeBranch} required={true} readOnly={readOnly}/>
                                </div>
                            </fieldset>
                            <fieldset className='my-1 row-span-2 overflow-auto'>
                                <legend className='sub-heading'>Contact Person Details</legend>
                                <div className='grid grid-cols-1 my-2'>
                                    <TextInput name="Name" type="text" value={contactNameBranch} setValue={setContactNameBranch} required={true} readOnly={readOnly}/>
                                    <TextInput name="Mobile No" type="number" value={contactMobileBranch} setValue={setContactMobileBranch} required={true} readOnly={readOnly}/>
                                    <TextInput name="Email id" type="text" value={contactEmailBranch} setValue={setContactEmailBranch} required={true} readOnly={readOnly}/>
                                </div>
                            </fieldset>
                            <div className='flex justify-between text-sm'>
                                <CheckBox name="Active" value={activeBranch} setValue={setActiveBranch} readOnly={readOnly}/>
                            </div>
                        </div>
                    </div>
