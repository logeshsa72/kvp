...
export default function Form() {
  ...
  const data = {
    ...
    validFrom, expireAt, maxUsers, id
  }
  ...
  return (
    <>
      <Modal isOpen={userForm} onClose={() => setUserForm(false)} widthClass={"w-[900px] h-[500px] pt-10"}>
        <UserRoles />
      </Modal>
      <Modal isOpen={branchForm} onClose={() => setBranchForm(false)} widthClass={"w-[900px] h-[500px] pt-10"}>
            ...
            <div className='col-span-3 grid md:grid-cols-2 border'>
              <fieldset className='frame mr-1 md:m-1 overflow-auto'>
                ...
                <div className='grid grid-cols-1 my-2'>
                  <TextInput name="Company Name" type="text" value={name} setValue={setName} required={true} readOnly={readOnly} />
                ...
                <fieldset className='row-span-2 overflow-auto'>
                  ...
                  <div className='grid grid-cols-1 my-2'>
                    <TextInput name="Name" type="text" value={contactName} setValue={setContactName} required={true} readOnly={readOnly} />
                    <TextInput name="Mobile No" type="number" value={contactMobile} setValue={setContactMobile} required={true} readOnly={readOnly} />
                    <TextInput name="Email id" type="text" value={contactEmail} setValue={setContactEmail} required={true} readOnly={readOnly} />
                  </div>
                </fieldset>
                {id ?
