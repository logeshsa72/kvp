...
export default function Form() {
    ...
    const { data: stateList, isLoading: isStateLoading, isFetching: isStateFetching } = useGetStateQuery({params:{ ...params, active: true }}, {skip: !form});
                                ...
                                <div className='mr-1 md:ml-2'>
                                    <fieldset className='frame my-1'>
                                        ...
                                        <div className='grid grid-cols-1 my-2'>
                                            <TextInput name="City Name" type="text" value={name} setValue={setName} required={true} readOnly={readOnly} />
                                            <TextInput name="Code" type="text" value={code} setValue={setCode} required={true} readOnly={readOnly} />
                                            <DropdownInput name="State" options={dropDownListObject(stateList.data, "name", "id")} value={state} setValue={setState} required={true} readOnly={readOnly} />
                                            <DisabledInput name="Country" type="text" value={countryFromState()} />
