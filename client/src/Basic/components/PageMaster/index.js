...
export default function Form() {
  ...
  const {data: pageGroupData, isLoading: isGroupLoading, isFetching: isGroupFetching } = useGetPageGroupQuery({searchParams: searchValue})
  ...
  return (
    <div
      ...
      className="md:items-start md:justify-items-center grid h-full bg-sky-700"
    >
