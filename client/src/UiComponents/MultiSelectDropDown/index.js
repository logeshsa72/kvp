...
export default function MultiLevelDropDown({ heading, pages, groups }) {
                ...
                <ul
                    ...
                    {groups.map(group =>
                        <li key={group?.id} className="rounded-md relative">
                            ...
                            <ul className="bg-white tex-black border border-blue-300 drop-shadow-2xl rounded-xl absolute top-0 right-0 transition duration-150 ease-in-out origin-top-left z-50 w-60 p-3">
